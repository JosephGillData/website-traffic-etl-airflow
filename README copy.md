...
5. Create a .env file with ``` SMTP_PASSWORD=EMAIL_PASSWORD
...
9. Create another terminal, activate the virtual environment and run airflow on a local port - `airflow webserver --port 8080`.
